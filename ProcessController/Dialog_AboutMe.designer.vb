...
Partial Class Dialog_AboutMe
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox_Description.Text = "This application is designed to set each process" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "not specified to low priority a" & _
            "nd affinity to 1 core."
        '
        'Label_Description
        '
